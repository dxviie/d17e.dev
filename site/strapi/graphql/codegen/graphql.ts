...
export type GetArticlesQuery = { articles?: { data: Array<{ id?: string | null, attributes?: { title: string, slug: string, body: string, createdAt?: any | null, updatedAt?: any | null, cover?: { data?: { attributes?: { name: string, alternativeText?: string | null, url: string } | null } | null } | null, gallery?: { data: Array<{ attributes?: { name: string, alternativeText?: string | null, url: string } | null }> } | null, tags?: { data: Array<{ attributes?: { name: string, color?: string | null } | null }> } | null, author?: { data?: { attributes?: { name: string, avatar: { data?: { attributes?: { url: string } | null } | null } } | null } | null } | null } | null }> } | null };
...
export type GetArticleByIdQuery = { article?: { data?: { id?: string | null, attributes?: { title: string, slug: string, body: string, createdAt?: any | null, updatedAt?: any | null, cover?: { data?: { attributes?: { name: string, alternativeText?: string | null, url: string } | null } | null } | null, gallery?: { data: Array<{ attributes?: { name: string, alternativeText?: string | null, url: string } | null }> } | null, tags?: { data: Array<{ attributes?: { name: string, color?: string | null } | null }> } | null, author?: { data?: { attributes?: { name: string, avatar: { data?: { attributes?: { url: string } | null } | null } } | null } | null } | null } | null } | null } | null };
